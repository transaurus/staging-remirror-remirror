...
__export(src_exports, {
  EditorViewSSR: () => EditorViewSSR,
  ReactSerializer: () => ReactSerializer,
  RemirrorSSR: () => RemirrorSSR,
...
function getPossibleStandardName(key) {
  var _a;
  if (!(0, import_core.hasOwnProperty)(possibleStandardNames, key)) {
    return key;
  }
  return (_a = possibleStandardNames[key]) != null ? _a : key;
}
function mapProps(props) {
  const transformedProps = (0, import_core.object)();
  for (const key of (0, import_core.keys)(props)) {
...
function gatherDomMethods(specs) {
  ...
  for (const name in specs) {
    if (!(0, import_core.hasOwnProperty)(specs, name)) {
      continue;
    }
...
var _ReactSerializer = class _ReactSerializer {
  constructor(nodes, marks, manager) {
    ...
    this.nodes = nodes;
    this.marks = marks;
    __privateSet(this, _components, (_a = manager.store.components) != null ? _a : (0, import_core2.object)());
  ...
  static renderSpec(structure, wraps) {
    if ((0, import_core2.isString)(structure)) {
      return structure;
    }
    const Component = structure[0];
    const props = (0, import_core2.object)();
    const attributes = structure[1];
    const children = [];
    let currentIndex = 1;
    if ((0, import_core2.isPlainObject)(attributes) && !(0, import_core2.isArray)(attributes)) {
      currentIndex = 2;
    ...
    for (let ii = currentIndex; ii < structure.length; ii++) {
      ...
      if (child === 0) {
        (0, import_core2.invariant)(!(ii < structure.length - 1 || ii > currentIndex), {
          message: "Content hole (0) must be the only child of its parent node",
          code: import_core2.ErrorConstant.INTERNAL
        });
        return (0, import_react.createElement)(Component, mapProps(props), wraps);
      }
      children.push(_ReactSerializer.renderSpec(child, wraps));
    }
    return (0, import_react.createElement)(Component, mapProps(props), ...children);
  }
  /**
  ...
  serializeFragment(fragment) {
    ...
    return (0, import_react.createElement)(import_react.Fragment, {}, ...children);
  }
  /**
  ...
  serializeNode(node) {
    ...
    if (managerStoreComponent) {
      ...
      return /* @__PURE__ */ import_react.default.createElement(Component, __spreadProps(__spreadValues({}, props), { node, view: __privateGet(this, _view) }), children);
    }
...
var RemirrorSSR = (props) => {
  ...
  return /* @__PURE__ */ import_react2.default.createElement("div", __spreadProps(__spreadValues({}, outerProperties), { suppressContentEditableWarning: true, contentEditable: editable }), transformedElement);
};
...
var EditorViewSSR = class {
  constructor(_place, props) {
    ...
    const doc = (0, import_core3.getDocument)();
    this.root = doc;
...
function createEditorView(place, props) {
  const Constructor = (0, import_core3.shouldUseDomEnvironment)() ? import_view.EditorView : (0, import_core3.Cast)(EditorViewSSR);
