...
var DomFramework = class extends import_core.Framework {
  ...
  createView(state, element) {
    return new import_view.EditorView(element != null ? element : null, {
      state,
...
function createDomEditor(props) {
  ...
  const [initialContent, initialSelection] = (0, import_core2.isArray)(props.initialContent) ? props.initialContent : [(_a = props.initialContent) != null ? _a : fallback];
