...
var spawningEffect = {
  ...
  updateParticle({ particle, ctx }) {
    ...
    particle.theta = ((_c = particle.theta) != null ? _c : createSpawningTheta()) + randomInt(-0.5, 0.5);
...
_EpicModeExtension_decorators = [extension({
  defaultOptions: {
...
var EpicModeExtension = class extends (_a = PlainExtension) {
  get name() {
    return "epicMode";
  }
  createPlugin() {
