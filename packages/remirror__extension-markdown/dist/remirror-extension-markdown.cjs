...
function isFirstTbody(element) {
  ...
  return (0, import_core.isElementDomNode)(previousSibling) && previousSibling.nodeName === "THEAD" && !((_a2 = previousSibling.textContent) == null ? void 0 : _a2.trim());
}
...
_MarkdownExtension_decorators = [(0, import_core2.extension)({
  defaultOptions: {
    htmlToMarkdown,
    markdownToHtml,
...
var MarkdownExtension = class extends (_a = import_core2.PlainExtension, _insertMarkdown_dec = [(0, import_core2.command)()], _getMarkdown_dec = [(0, import_core2.helper)()], _toggleBoldMarkdown_dec = [(0, import_core2.command)()], _a) {
  constructor() {
    super(...arguments);
