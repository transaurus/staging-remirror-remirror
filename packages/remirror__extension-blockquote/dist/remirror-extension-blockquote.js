...
var BlockquoteExtension = class extends (_a = NodeExtension, _toggleBlockquote_dec = [command({
  icon: "doubleQuotesL",
  description: ({ t }) => t(Messages.DESCRIPTION),
  label: ({ t }) => t(Messages.LABEL)
})], _shortcut_dec = [keyBinding({ shortcut: "Ctrl->", command: "toggleBlockquote" })], _a) {
  constructor() {
    super(...arguments);
