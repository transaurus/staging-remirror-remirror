...
__export(src_exports, {
  StrikeExtension: () => StrikeExtension
});
...
var toggleStrikeOptions = {
  icon: "strikethrough",
  label: ({ t }) => t(import_messages.ExtensionStrikeMessages.LABEL),
  description: ({ t }) => t(import_messages.ExtensionStrikeMessages.DESCRIPTION)
};

// src/strike-extension.ts
var _shortcut_dec, _toggleStrike_dec, _a, _StrikeExtension_decorators, _init;
_StrikeExtension_decorators = [(0, import_core.extension)({})];
var StrikeExtension = class extends (_a = import_core.MarkExtension, _toggleStrike_dec = [(0, import_core.command)(toggleStrikeOptions)], _shortcut_dec = [(0, import_core.keyBinding)({ shortcut: import_core.NamedShortcut.Strike, command: "toggleStrike" })], _a) {
  constructor() {
    super(...arguments);
  ...
  createInputRules() {
    return [(0, import_core.markInputRule)({ regexp: /~([^~]+)~$/, type: this.type, ignoreWhitespace: true })];
  }
  createPasteRules() {
