...
_DocExtension_decorators = [(0, import_core.extension)({
  defaultOptions: {
    content: "block+",
    docAttributes: []
  },
...
var DocExtension = class extends (_a = import_core.NodeExtension, _setDocAttributes_dec = [(0, import_core.command)()], _isDefaultDocNode_dec = [(0, import_core.helper)()], _a) {
  constructor() {
    super(...arguments);
  ...
  createNodeSpec(_, override) {
    ...
    const attrs = (0, import_core.object)();
    if ((0, import_core.isPlainObject)(docAttributes)) {
      for (const [key, value] of (0, import_core.entries)(docAttributes)) {
  ...
  isDefaultDocNode({
    ...
    return (0, import_core.isDefaultDocNode)(state.doc, options);
  }
};
