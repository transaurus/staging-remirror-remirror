...
var FileIcon = () => /* @__PURE__ */ React.createElement(
  "svg",
  {
    stroke: "currentColor",
    fill: "currentColor",
  ...
  /* @__PURE__ */ React.createElement("path", { fill: "none", d: "M0 0h24v24H0z" }),
  /* @__PURE__ */ React.createElement("path", { d: "M3 8l6.003-6h10.995C20.55 2 21 2.455 21 2.992v18.016a.993.993 0 0 1-.993.992H3.993A1 1 0 0 1 3 20.993V8zm7-4v5H5v11h14V4h-9z" })
);
var DownloadIcon = () => /* @__PURE__ */ React.createElement(
  ...
  /* @__PURE__ */ React.createElement("path", { fill: "none", d: "M0 0h24v24H0z" }),
  /* @__PURE__ */ React.createElement("path", { d: "M3 19h18v2H3v-2zm10-5.828L19.071 7.1l1.414 1.414L12 17 3.515 8.515 4.929 7.1 11 13.17V2h2v11.172z" })
);
var DeleteIcon = () => /* @__PURE__ */ React.createElement(
  ...
  /* @__PURE__ */ React.createElement("path", { fill: "none", d: "M0 0h24v24H0z" }),
  /* @__PURE__ */ React.createElement("path", { d: "M7 4V2h10v2h5v2h-2v15a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V6H2V4h5zM6 6v14h12V6H6zm3 3h2v8H9V9zm4 0h2v8h-2V9z" })
);
var StopIcon = () => /* @__PURE__ */ React.createElement(
  "svg",
  {
    stroke: "currentColor",
    fill: "currentColor",
  ...
  /* @__PURE__ */ React.createElement("path", { fill: "none", d: "M0 0h24v24H0z" }),
  /* @__PURE__ */ React.createElement("path", { d: "M12 10.586l4.95-4.95 1.414 1.414-4.95 4.95 4.95 4.95-1.414 1.414-4.95-4.95-4.95 4.95-1.414-1.414 4.95-4.95-4.95-4.95L7.05 5.636z" })
);
...
var FileComponent = ({
  ...
  return /* @__PURE__ */ React2.createElement("div", { className: ExtensionFileTheme.FILE_ROOT }, /* @__PURE__ */ React2.createElement(IconButton, null, /* @__PURE__ */ React2.createElement(FileIcon, null)), /* @__PURE__ */ React2.createElement("div", { className: ExtensionFileTheme.FILE_NAME }, attrs.fileName), /* @__PURE__ */ React2.createElement("div", { className: ExtensionFileTheme.FILE_SIZE }, fileSize), /* @__PURE__ */ React2.createElement("div", { style: { flex: 1, minWidth: "8px" } }), context ? /* @__PURE__ */ React2.createElement(UploadingFileAction, { context, abort }) : /* @__PURE__ */ React2.createElement(UploadedFileAction, { attrs, getPosition }));
};
var UploadingFileAction = ({
  ...
  return /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement("div", { className: ExtensionFileTheme.FILE_UPLOAD_PROGRESS }, progress), /* @__PURE__ */ React2.createElement(StopButton, { abort }));
};
var UploadedFileAction = ({ attrs, getPosition }) => /* @__PURE__ */ React2.createElement(React2.Fragment, null, attrs.error ? /* @__PURE__ */ React2.createElement("div", { className: ExtensionFileTheme.FILE_ERROR }, attrs.error) : /* @__PURE__ */ React2.createElement(DownloadFileButton, { attrs }), /* @__PURE__ */ React2.createElement("div", { style: { minWidth: "8px" } }), /* @__PURE__ */ React2.createElement(DeleteFileButton, { getPosition }));
var IconButton = (props) => /* @__PURE__ */ React2.createElement(
  "a",
...
var StopButton = ({ abort }) => /* @__PURE__ */ React2.createElement(IconButton, { onClick: abort }, /* @__PURE__ */ React2.createElement(StopIcon, null));
var DeleteFileButton = ({ getPosition }) => {
  const { deleteFile } = useCommands();
  return /* @__PURE__ */ React2.createElement(IconButton, { onClick: () => deleteFile(getPosition()) }, /* @__PURE__ */ React2.createElement(DeleteIcon, null));
};
var DownloadFileButton = ({ attrs }) => /* @__PURE__ */ React2.createElement(IconButton, { href: attrs.url, download: attrs.fileName, target: "_blank", rel: "noreferrer" }, /* @__PURE__ */ React2.createElement(DownloadIcon, null));
...
_FileExtension_decorators = [extension({
  defaultOptions: {
...
var FileExtension = class extends (_a = NodeExtension, _uploadFiles_dec = [command()], _updateFile_dec = [command()], _insertFile_dec = [command()], _deleteFile_dec = [command()], _renameFile_dec = [command()], _backspaceShortcut_dec = [keyBinding({ shortcut: ["Backspace", "Delete"] })], _a) {
  constructor() {
    super(...arguments);
    __runInitializers(_init, 5, this);
    __publicField(this, "ReactComponent", (props) => {
      const payload = findUploadPlaceholderPayload(props.view.state, props.node.attrs.id);
  ...
  createNodeSpec(extra, override) {
    ...
    return __spreadProps(__spreadValues({
      ...
      toDOM: (node) => {
        const _a3 = omitExtraAttributes(node.attrs, extra), { url, error } = _a3, rest = __objRest(_a3, ["url", "error"]);
