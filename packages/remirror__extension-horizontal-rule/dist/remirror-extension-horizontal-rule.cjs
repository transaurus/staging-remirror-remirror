...
// src/horizontal-rule-extension.ts
var _insertHorizontalRule_dec, _a, _HorizontalRuleExtension_decorators, _init;
_HorizontalRuleExtension_decorators = [(0, import_core.extension)({
  defaultOptions: { insertionNode: "paragraph" }
})];
var HorizontalRuleExtension = class extends (_a = import_core.NodeExtension, _insertHorizontalRule_dec = [(0, import_core.command)(insertHorizontalRuleOptions)], _a) {
  constructor() {
    super(...arguments);
  ...
  createNodeSpec(extra, override) {
    ...
    return __spreadProps(__spreadValues({}, override), {
      ...
      parseDOM: [{ tag: "hr", getAttrs: extra.parse }, ...(_a2 = override.parseDOM) != null ? _a2 : []],
  ...
  updateFromNodeSelection(tr) {
    ...
    (0, import_core.invariant)(type, {
      ...
      message: "'".concat(insertionNode, "' node provided as the insertionNode to the '").concat(this.constructorName, "' does not exist.")
    });
...
__decorateElement(_init, 1, "insertHorizontalRule", _insertHorizontalRule_dec, HorizontalRuleExtension);
HorizontalRuleExtension = __decorateElement(_init, 0, "HorizontalRuleExtension", _HorizontalRuleExtension_decorators, HorizontalRuleExtension);
__runInitializers(_init, 1, HorizontalRuleExtension);
