...
_CollaborationExtension_decorators = [(0, import_core.extension)({
  defaultOptions: {
    version: 0,
...
var CollaborationExtension = class extends (_a = import_core.PlainExtension, _sendCollaborationUpdate_dec = [(0, import_core.command)()], _cancelSendableSteps_dec = [(0, import_core.command)()], _flushSendableSteps_dec = [(0, import_core.command)()], _a) {
  constructor() {
    super(...arguments);
...
var isValidCollaborationAttributes = (attributes) => !(!attributes || !(0, import_core.isArray)(attributes.steps) || !(0, import_core.isNumber)(attributes.version));
