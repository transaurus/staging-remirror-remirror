...
__export(src_exports, {
  BidiExtension: () => BidiExtension
});
module.exports = __toCommonJS(src_exports);

// src/bidi-extension.ts
var import_direction = __toESM(require("direction"), 1);
...
var setTextDirectionOptions = {
  ...
  description: ({ t, attrs }) => t(import_messages.ExtensionBidiMessages.DESCRIPTION, { dir: attrs == null ? void 0 : attrs.dir }),
  label: ({ t, attrs }) => t(import_messages.ExtensionBidiMessages.LABEL, { dir: attrs == null ? void 0 : attrs.dir })
};
var _setTextDirection_dec, _a, _BidiExtension_decorators, _init;
_BidiExtension_decorators = [(0, import_core.extension)({
  defaultOptions: {
...
var BidiExtension = class extends (_a = import_core.PlainExtension, _setTextDirection_dec = [(0, import_core.command)(setTextDirectionOptions)], _a) {
  constructor() {
    super(...arguments);
    ...
    return [
      {
        identifiers: {
          type: "node",
          tags: [import_core.ExtensionTag.BlockNode],
    ...
    return {
      state: {
        ...
        apply: (tr) => {
          ...
          return (0, import_core.hasTransactionChanged)(tr);
        }
      },
   ...
   */
  getDirection(text) {
    if (!(0, import_core.isString)(text)) {
      return;
    }
    const dir = (0, import_direction.default)(text);
    if (dir === "neutral") {
  ...
  setTextDirection(dir, options = {}) {
    return (props) => {
      ...
      const parent = findParent(
        (0, import_core.getTextSelection)(selection != null ? selection : tr.selection, tr.doc),
...
function findParent(selection, excludeNodes) {
  return (0, import_core.findParentNode)({
