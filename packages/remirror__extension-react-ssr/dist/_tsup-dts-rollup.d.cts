...
declare interface ManagerStoreReactComponent {
    Component: ComponentType<PropsWithChildren<NodeViewComponentProps>>;
    props: Omit<NodeViewComponentProps, 'node' | 'view'>;
}
export { ManagerStoreReactComponent }
export { ManagerStoreReactComponent as ManagerStoreReactComponent_alias_1 }

declare type SsrTransformer = (element: JSX.Element, state?: EditorState) => JSX.Element;
export { SsrTransformer }
export { SsrTransformer as SsrTransformer_alias_1 }
