...
__export(src_exports, {
  ...
  ReactComponentExtension: () => ReactComponentExtension,
  RemirrorPortals: () => RemirrorPortals,
...
var PortalContainer = class {
  constructor() {
     ...
     */
    __privateAdd(this, _events, (0, import_nanoevents.createNanoEvents)());
    /**
  ...
  render({ Component, container }) {
    ...
    this.portals.set(container, { Component, key: (_a2 = portal == null ? void 0 : portal.key) != null ? _a2 : (0, import_core_helpers.uniqueId)() });
    this.update();
  }
  /**
  ...
  forceUpdate() {
    for (const [container, { Component }] of this.portals) {
      this.portals.set(container, { Component, key: (0, import_core_helpers.uniqueId)() });
    }
  }
  /**
...
var RemirrorPortals = (props) => {
  const { portals } = props;
  return /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, portals.map(
    ([container, { Component, key }]) => (0, import_react_dom.createPortal)(/* @__PURE__ */ import_react.default.createElement(Component, null), container, key)
  ));
};
function usePortals(portalContainer) {
  ...
  return (0, import_react.useMemo)(() => portals, [portals]);
}
...
var _ReactNodeView = class _ReactNodeView {
  ...
  constructor({
    ...
    __privateAdd(this, _forwardRef, (node) => {
      ...
      (0, import_core_helpers2.invariant)(__privateGet(this, _contentDOMWrapper), {
        code: import_core_constants.ErrorConstant.REACT_NODE_VIEW,
    ...
    __publicField(this, "Component", () => {
      ...
      (0, import_core_helpers2.invariant)(ReactComponent, {
        code: import_core_constants.ErrorConstant.REACT_NODE_VIEW,
    ...
    var _a2;
    (0, import_core_helpers2.invariant)((0, import_core_helpers2.isFunction)(getPosition), {
    ...
    this.Component.displayName = (0, import_core_helpers2.pascalCase)("".concat(__privateGet(this, _node).type.name, "NodeView"));
  ...
  createDom() {
    ...
    element.classList.add("".concat((0, import_core_helpers2.kebabCase)(__privateGet(this, _node).type.name), "-node-view-wrapper"));
    return element;
  }
  /**
  ...
  createContentDom() {
    ...
    const { contentDOM, dom } = import_model.DOMSerializer.renderSpec(document, domSpec);
    let wrapper;
    if (!(0, import_core_utils.isElementDomNode)(dom)) {
      return;
    }
    wrapper = dom;
    if (dom === contentDOM) {
      wrapper = document.createElement("span");
      wrapper.classList.add("".concat((0, import_core_helpers2.kebabCase)(__privateGet(this, _node).type.name), "-node-view-content-wrapper"));
      wrapper.append(contentDOM);
    }
    if ((0, import_core_utils.isElementDomNode)(contentDOM)) {
    }
  ...
  update(node, decorations) {
    if (!(0, import_core_utils.isNodeOfType)({ types: __privateGet(this, _node).type, node })) {
      return false;
    }
  ...
  setDomAttributes(node, element) {
    ...
    if (toDOM) {
      ...
      if ((0, import_core_helpers2.isString)(domSpec) || isDomNodeOutputSpec(domSpec)) {
        return;
      }
      if ((0, import_core_helpers2.isPlainObject)(domSpec[1])) {
        attributes = domSpec[1];
      }
    }
    for (const [attribute, value] of (0, import_core_helpers2.entries)(attributes)) {
  ...
  selectNode() {
    ...
    if (__privateGet(this, _dom)) {
      __privateGet(this, _dom).classList.add(import_core_constants.SELECTED_NODE_CLASS_NAME);
    }
    this.renderComponent();
  }
  /**
  ...
  deselectNode() {
    ...
    if (__privateGet(this, _dom)) {
      __privateGet(this, _dom).classList.remove(import_core_constants.SELECTED_NODE_CLASS_NAME);
    }
    this.renderComponent();
  }
  /**
  ...
  stopEvent(event) {
    ...
    if ((0, import_core_helpers2.isFunction)(__privateGet(this, _options).stopEvent)) {
    ...
    const isSelectable = import_state.NodeSelection.isSelectable(__privateGet(this, _node));
...
function isDomNodeOutputSpec(value) {
  return (0, import_core_utils.isDomNode)(value) || (0, import_core_helpers2.isPlainObject)(value) && (0, import_core_utils.isDomNode)(value.dom);
}

// src/react-component-extension.ts
var _ReactComponentExtension_decorators, _init, _a;
_ReactComponentExtension_decorators = [(0, import_core.extension)({
  defaultOptions: {
...
var ReactComponentExtension = class extends (_a = import_core.PlainExtension) {
  constructor() {
    super(...arguments);
    /**
  ...
  createNodeViews() {
    var _a2;
    const nodeViews = (0, import_core_helpers3.object)();
    ...
    for (const extension2 of this.store.extensions) {
      if (!extension2.ReactComponent || !(0, import_core.isNodeExtension)(extension2) || extension2.reactComponentEnvironment === "ssr") {
        continue;
      }
    ...
    const namedComponents = (0, import_core_helpers3.entries)(__spreadValues(__spreadValues({}, this.options.nodeViewComponents), managerComponents));
