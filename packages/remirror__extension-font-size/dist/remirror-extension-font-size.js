...
_FontSizeExtension_decorators = [extension({
  defaultOptions: {
    defaultSize: "",
    unit: "pt",
    increment: 1,
...
var FontSizeExtension = class extends (_a = MarkExtension, _setFontSize_dec = [command(setFontSizeOptions)], _increaseFontSize_dec = [command(increaseFontSizeOptions)], _decreaseFontSize_dec = [command(decreaseFontSizeOptions)], _removeFontSize_dec = [command()], _increaseFontSizeShortcut_dec = [keyBinding({ shortcut: NamedShortcut.IncreaseFontSize, command: "increaseFontSize" })], _decreaseFontSizeShortcut_dec = [keyBinding({ shortcut: NamedShortcut.IncreaseFontSize, command: "decreaseFontSize" })], _getFontSizeForSelection_dec = [helper()], _getFontSizeFromDom_dec = [helper()], _a) {
  constructor() {
    super(...arguments);
  ...
  createMarkSpec(extra, override) {
    ...
    return __spreadProps(__spreadValues({}, override), {
      ...
      parseDOM: [
        {
          ...
          getAttrs: (dom) => {
            ...
            size = "".concat(convertPixelsToDomUnit(size, this.options.unit, dom)).concat(this.options.unit);
      ...
      toDOM: (mark) => {
        const _a3 = omitExtraAttributes(mark.attrs, extra), { size } = _a3, other = __objRest(_a3, ["size"]);
  ...
  getFontSize(size) {
    ...
    const fontSize = convertPixelsToDomUnit(size, unit, (_a2 = this.store.view) == null ? void 0 : _a2.dom);
  ...
  getFontSizeForSelection(position) {
    ...
    const selection = getTextSelection(position != null ? position : state.selection, state.doc);
