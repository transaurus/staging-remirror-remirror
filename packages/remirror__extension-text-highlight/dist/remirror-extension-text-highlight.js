...
_TextHighlightExtension_decorators = [extension({
  defaultOptions: {
    defaultHighlight: "",
    palette
  },
...
var TextHighlightExtension = class extends (_a = MarkExtension, _setTextHighlight_dec = [command(setTextHighlightOptions)], _removeTextHighlight_dec = [command()], _a) {
  constructor() {
    super(...arguments);
