...
var use_mention_atom_exports = {};
__export(use_mention_atom_exports, {
  useMentionAtom: () => useMentionAtom
});
module.exports = __toCommonJS(use_mention_atom_exports);
...
function useMentionAtom(props) {
  ...
  (0, import_react_core4.useExtensionEvent)(import_extension_mention_atom.MentionAtomExtension, "onChange", onChange);
