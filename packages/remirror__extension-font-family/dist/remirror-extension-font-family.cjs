...
_FontFamilyExtension_decorators = [(0, import_core.extension)({})];
var FontFamilyExtension = class extends (_a = import_core.MarkExtension, _setFontFamily_dec = [(0, import_core.command)()], _toggleFontFamily_dec = [(0, import_core.command)()], _a) {
  constructor() {
    super(...arguments);
    ...
    return __spreadProps(__spreadValues({}, override), {
      ...
      parseDOM: [
        ...
        },
        {
          ...
          getAttrs: (fontFamily) => {
            if (!(0, import_core.isString)(fontFamily)) {
              return false;
            }
            return {
      ...
      toDOM: (mark) => {
        const { fontFamily } = (0, import_core.omitExtraAttributes)(mark.attrs, extra);
        const extraAttrs = extra.dom(mark);
        let style = extraAttrs.style;
        style = (0, import_core.joinStyles)({ fontFamily }, style);
