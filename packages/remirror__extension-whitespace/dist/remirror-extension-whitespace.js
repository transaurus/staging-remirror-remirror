...
_WhitespaceExtension_decorators = [extension({
  defaultOptions: {
...
var WhitespaceExtension = class extends (_a = PlainExtension, _toggleWhitespace_dec = [command(toggleWhitespaceOptions)], _showWhitespace_dec = [command()], _hideWhitespace_dec = [command()], _isWhitespaceVisible_dec = [helper()], _a) {
  constructor() {
    super(...arguments);
     ...
     */
    __publicField(this, "decorationSet", DecorationSet2.empty);
    /**
