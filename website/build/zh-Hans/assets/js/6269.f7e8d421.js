...
;// CONCATENATED MODULE: ../node_modules/.pnpm/@lezer+cpp@1.0.0/node_modules/@lezer/cpp/dist/index.es.js
...
const rawString = new dist/* ExternalTokenizer */.Lu(input => {
...
const fallback = new dist/* ExternalTokenizer */.Lu(input => {
...
const cppHighlighting = (0,highlight_dist/* styleTags */.pn)({
  "typedef struct union enum class typename decltype auto template operator friend noexcept namespace using __attribute__ __declspec __based": highlight_dist/* tags */._A.definitionKeyword,
  "extern MsCallModifier MsPointerModifier extern static register inline const volatile restrict _Atomic mutable constexpr virtual explicit VirtualSpecifier Access": highlight_dist/* tags */._A.modifier,
  "if else switch for while do case default return break continue goto throw try catch": highlight_dist/* tags */._A.controlKeyword,
  "new sizeof delete static_assert": highlight_dist/* tags */._A.operatorKeyword,
  "NULL nullptr": highlight_dist/* tags */._A.null,
  this: highlight_dist/* tags */._A.self,
  "True False": highlight_dist/* tags */._A.bool,
  "TypeSize PrimitiveType": highlight_dist/* tags */._A.standard(highlight_dist/* tags */._A.typeName),
  ...
  StatementIdentifier: highlight_dist/* tags */._A.labelName,
  "Identifier DestructorName": highlight_dist/* tags */._A.variableName,
  "CallExpression/Identifier": highlight_dist/* tags */._A.function(highlight_dist/* tags */._A.variableName),
  "CallExpression/ScopedIdentifier/Identifier": highlight_dist/* tags */._A.function(highlight_dist/* tags */._A.variableName),
  "FunctionDeclarator/Identifier FunctionDeclarator/DestructorName": highlight_dist/* tags */._A.function(highlight_dist/* tags */._A.definition(highlight_dist/* tags */._A.variableName)),
  NamespaceIdentifier: highlight_dist/* tags */._A.namespace,
  OperatorName: highlight_dist/* tags */._A.operator,
  ...
  "RawString SystemLibString": highlight_dist/* tags */._A.special(highlight_dist/* tags */._A.string),
  CharLiteral: highlight_dist/* tags */._A.character,
  EscapeSequence: highlight_dist/* tags */._A.escape,
  PreProcArg: highlight_dist/* tags */._A.meta,
  "PreprocDirectiveName #include #ifdef #ifndef #if #define #else #endif #elif": highlight_dist/* tags */._A.processingInstruction,
  MacroName: highlight_dist/* tags */._A.special(highlight_dist/* tags */._A.name),
  "( )": highlight_dist/* tags */._A.paren,
  "[ ]": highlight_dist/* tags */._A.squareBracket,
  "{ }": highlight_dist/* tags */._A.brace,
  "< >": highlight_dist/* tags */._A.angleBracket,
...
;// CONCATENATED MODULE: ../node_modules/.pnpm/@codemirror+lang-cpp@6.0.1/node_modules/@codemirror/lang-cpp/dist/index.js
...
*/
const cppLanguage = /*@__PURE__*/language_dist/* LRLanguage */.bj.define({
    parser: /*@__PURE__*/parser.configure({
        props: [
            /*@__PURE__*/language_dist/* indentNodeProp */.Oh.add({
                ...
                TryStatement: /*@__PURE__*/(0,language_dist/* continuedIndent */.mz)({ except: /^\s*({|catch)\b/ }),
                LabeledStatement: language_dist/* flatIndent */._Y,
                CaseStatement: context => context.baseIndent + context.unit,
                BlockComment: () => -1,
                CompoundStatement: /*@__PURE__*/(0,language_dist/* delimitedIndent */.Ay)({ closing: "}" }),
                Statement: /*@__PURE__*/(0,language_dist/* continuedIndent */.mz)({ except: /^{/ })
            }),
            /*@__PURE__*/language_dist/* foldNodeProp */.b_.add({
                "DeclarationList CompoundStatement EnumeratorList FieldDeclarationList InitializerList": language_dist/* foldInside */.yd,
...
*/
function cpp() {
    return new language_dist/* LanguageSupport */.Yy(cppLanguage);
}
