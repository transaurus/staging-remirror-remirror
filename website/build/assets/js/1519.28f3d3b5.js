"use strict";
exports.id = 1519;
exports.ids = [1519,6604,811,9609];
exports.modules = {
...
const parser = /*@__PURE__*/_lezer_lr__WEBPACK_IMPORTED_MODULE_2__/* .LRParser */ .U1.deserialize({
  ...
  tokenizers: [6, 7, /*@__PURE__*/new _lezer_lr__WEBPACK_IMPORTED_MODULE_2__/* .LocalTokenGroup */ .uC("b~RP#q#rU~XP#q#r[~aOT~~", 17, 4), /*@__PURE__*/new _lezer_lr__WEBPACK_IMPORTED_MODULE_2__/* .LocalTokenGroup */ .uC("!k~RQvwX#o#p!_~^TU~Opmq!]m!^;'Sm;'S;=`!X<%lOm~pUOpmq!]m!]!^!S!^;'Sm;'S;=`!X<%lOm~!XOU~~![P;=`<%lm~!bP#o#p!e~!jOk~~", 72, 2), /*@__PURE__*/new _lezer_lr__WEBPACK_IMPORTED_MODULE_2__/* .LocalTokenGroup */ .uC("[~RPwxU~ZOp~~", 11, 15), /*@__PURE__*/new _lezer_lr__WEBPACK_IMPORTED_MODULE_2__/* .LocalTokenGroup */ .uC("[~RPrsU~ZOn~~", 11, 14), /*@__PURE__*/new _lezer_lr__WEBPACK_IMPORTED_MODULE_2__/* .LocalTokenGroup */ .uC("!e~RQvwXwx!_~^Tc~Opmq!]m!^;'Sm;'S;=`!X<%lOm~pUOpmq!]m!]!^!S!^;'Sm;'S;=`!X<%lOm~!XOc~~![P;=`<%lm~!dOt~~", 66, 35), /*@__PURE__*/new _lezer_lr__WEBPACK_IMPORTED_MODULE_2__/* .LocalTokenGroup */ .uC("!e~RQrsXvw^~^Or~~cTb~Oprq!]r!^;'Sr;'S;=`!^<%lOr~uUOprq!]r!]!^!X!^;'Sr;'S;=`!^<%lOr~!^Ob~~!aP;=`<%lr~", 66, 33)],
...
const baseParser = /*@__PURE__*/parser.configure({
    props: [
        /*@__PURE__*/(0,_lezer_highlight__WEBPACK_IMPORTED_MODULE_0__/* .styleTags */ .pn)({
            ...
            VueAttributeName: _lezer_highlight__WEBPACK_IMPORTED_MODULE_0__/* .tags */ ._A.keyword,
            Identifier: _lezer_highlight__WEBPACK_IMPORTED_MODULE_0__/* .tags */ ._A.variableName,
            "AttributeValue ScriptAttributeValue": _lezer_highlight__WEBPACK_IMPORTED_MODULE_0__/* .tags */ ._A.attributeValue,
...
const attrParser = /*@__PURE__*/baseParser.configure({
    wrap: /*@__PURE__*/(0,_lezer_common__WEBPACK_IMPORTED_MODULE_1__/* .parseMixed */ .$g)((node, input) => node.name == "AttributeScript" ? exprMixed : null),
    top: "Attribute"
});
...
*/
const vueLanguage = /*@__PURE__*/_codemirror_language__WEBPACK_IMPORTED_MODULE_4__/* .LRLanguage */ .bj.define({
    name: "vue",
    parser: /*@__PURE__*/_codemirror_lang_html__WEBPACK_IMPORTED_MODULE_5__.htmlLanguage.parser.configure({
        dialect: "selfClosing",
        wrap: /*@__PURE__*/(0,_lezer_common__WEBPACK_IMPORTED_MODULE_1__/* .parseMixed */ .$g)(mixVue)
    }),
    languageData: {
        closeBrackets: { brackets: ["{", '"'] }
    }
...
*/
function vue() {
    return new _codemirror_language__WEBPACK_IMPORTED_MODULE_4__/* .LanguageSupport */ .Yy(vueLanguage);
}
