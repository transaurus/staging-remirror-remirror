 ...
 */
var cliArgs = camelCaseKeys__default["default"](minimist__default["default"](process.argv.slice(2)));
...
function mangleScopedPackageName(packageName) {
  ...
  assert__default["default"].ok(scope, "Invalid package name provided: ".concat(packageName));
  if (name) {
  ...
  _fileExists = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(filePath) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stat = fs__default["default"].lstatSync(filePath);
...
function baseDir() {
  return path__default["default"].resolve(__dirname, '../../..', path__default["default"].join(...arguments));
}
...
function getRelativePathFromJson(_ref2) {
  ...
  return path__default["default"].relative(baseDir(), location);
}
/**
...
function getAllDependencies() {
  ...
  if (!packages) {
    packages = getPackages.getPackages(baseDir()).then(_ref5 => {
        ...
        case 3:
          ...
          try {
            for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
              pkg = _step3.value;
              assert__default["default"].ok(pkg.name, 'Packages must include a name');
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.next = 3;
          return pre.readPreState(cwd);
        case 3:
          preState = _context4.sent;
          _context4.next = 6;
          return readChangesets__default["default"](cwd);
        case 6:
...
var diffOptions = {
  ...
  aColor: chalk__default["default"].red,
  bAnnotation: 'Generated',
  bColor: chalk__default["default"].green,
...
function orderOutputKeys(output) {
  return Object.keys(output).sort().map(name => path__default["default"].relative(process.cwd(), name));
}
...
function compareOutput(actual, expected) {
  ...
  if (!isEqual__default["default"](actualKeys, expectedKeys)) {
    throw new Error(chalk__default["default"](_templateObject || (_templateObject = _taggedTemplateLiteral(["\n{yellow The generated files are not identical to the original files.}\n\n", "\n"], ["\\n{yellow The generated files are not identical to the original files.}\\n\\n", "\\n"])), jestDiff.diff(actualKeys, expectedKeys, diffOptions) || ''));
  }
  var errorMessages = [];
  for (var _i = 0, _Object$entries = Object.entries(actual); _i < _Object$entries.length; _i++) {
    ...
    var relativeName = path__default["default"].relative(process.cwd(), name);
    if (isEqual__default["default"](actualContents, expectedContents)) {
      continue;
    }
    errorMessages.push(chalk__default["default"](_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["{grey ", "}\n", ""], ["{grey ", "}\\n", ""])), relativeName, jestDiff.diff(actualContents, expected[name], diffOptions)));
  }
  if (errorMessages.length > 0) {
    throw new Error(chalk__default["default"](_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n{bold.yellow The generated file contents differs from current content.}\n\n", "\n"], ["\\n{bold.yellow The generated file contents differs from current content.}\\n\\n", "\\n"])), errorMessages.join('\n\n')));
  }
}
var environment = {
  get isUnit() {
...
function watchFiles(files, callback) {
  var debounceCallback = throttleDebounce.debounce(1027, false, callback);
  var _iterator2 = _createForOfIteratorHelper(files),
    _step2;
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      var file = _step2.value;
      fs__default["default"].watchFile(file, {
        interval: 1007
      }, (curr, prev) => {
...
exports.getRelativePathFromJson = getRelativePathFromJson;
exports.getTypedPackagesWithPath = getTypedPackagesWithPath;
exports.log = log;
exports.mangleScopedPackageName = mangleScopedPackageName;
exports.readChangesetState = readChangesetState;
exports.rm = rm;
