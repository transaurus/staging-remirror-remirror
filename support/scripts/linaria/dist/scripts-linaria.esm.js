...
import { b as baseDir, r as rm } from '../../dist/helpers-894af5ce.esm.js';
 ...
 * @param {string[]} paths
 */
var files = globby.sync(['packages/remirror__theme/src/*.{ts,tsx}'], {
  cwd: baseDir(),
 ...
 * from.
 */
var outputDirectory = baseDir('packages/remirror__styles');
 ...
 * ```
 */
var groupedFiles = groupBy(files, file => {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          sampleFile = path.join(baseDir(), "sample".concat(extension)); // Check if the prettier config has been retrieved. If not, retrieve it.
        ...
        case 7:
          _context.next = 9;
          return prettier.resolveConfig(sampleFile);
        case 9:
        ...
        case 19:
          return _context.abrupt("return", prettier.format(contents, _objectSpread(_objectSpread({}, prettierConfig), {}, {
            parser
          })));
        case 20:
        case "end":
  ...
  _processCss = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(css, from, to) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return postcss([postcssNested, autoprefixer]).process(css, {
            from,
            to
          });
        case 2:
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 9:
          ...
          _context3.next = 12;
          return transform(fileContents.toString(), {
            filename,
            outputFilename,
            preprocessor: 'none'
...
function resolveCssOutputFilename(name) {
  return path.join(outputDirectory, "".concat(name, ".css"));
}
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.next = 3;
          return Promise.all([rm('packages/{@,}remirror/styles/*.css'), rm(tsFiles)]);
        case 3:
        case "end":
  ...
  _copyFilesToRemirror = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.next = 2;
          return cpy(['packages/remirror__styles/*.css'], 'packages/remirror/styles/');
        case 2:
        case "end":
  ...
  _writeOutput = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8(output) {
    ...
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        ...
        case 5:
          // We made it 🎉
          console.log(chalk(_templateObject || (_templateObject = _taggedTemplateLiteral(["{green Successfully extracted {bold ", "} CSS files.}"])), entries.length));
        case 6:
        case "end":
...
export { copyFilesToRemirror, getOutput, removeGeneratedFiles, writeOutput };
