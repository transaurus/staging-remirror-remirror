...
import { b as baseDir, m as mangleScopedPackageName } from '../../dist/helpers-894af5ce.esm.js';
...
var reportFolderRoot = baseDir('support', 'api');
var reportTempFolderRoot = baseDir('support', 'api', 'temp');
  ...
  _runApiExtractor = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 14:
          relativePath = path.relative(baseDir(), pkg.dir);
          projectFolder = baseDir(relativePath);
          mainEntryPointFilePath = path.join(pkg.dir, types);
          packageJsonFullPath = path.join(pkg.dir, 'package.json');
          apiJsonFilePath = path.join(reportFolderRoot, "".concat(name, ".api.json"));
          reportFilePath = path.join(reportFolderRoot, "".concat(name, ".api.md"));
          reportTempFilePath = path.join(reportTempFolderRoot, "".concat(name, ".api.md"));
          reportFileName = path.parse(reportFilePath).base;
          reportFolder = path.parse(reportFilePath).dir;
          reportTempFolder = path.parse(reportTempFilePath).dir;
          configObject = {
            projectFolder,
  ...
  _run = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return remove(reportFolderRoot);
        case 2:
          _context3.next = 4;
          return runApiExtractor();
        case 4:
          _context3.next = 6;
          return remove(reportTempFolderRoot);
        case 6:
        case "end":
