...
import { isString, deepMerge, isEmptyObject, assertGet, invariant } from '@remirror/core-helpers';
import { b as baseDir, l as log, d as formatFiles, c as cliArgs, h as getAllDependencies, g as getRelativePathFromJson, i as getTypedPackagesWithPath } from '../../dist/helpers-894af5ce.esm.js';
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          ...
          packageJsonPath = path.join(location, 'package.json');
          edited = false;
...
function getBrowserPath(pkg) {
  ...
  var browserPath = isString(pkg.browser) ? pkg.browser : (_pkg$browser = pkg.browser) === null || _pkg$browser === void 0 ? void 0 : _pkg$browser[prefixRelativePath((_pkg$module = pkg.module) !== null && _pkg$module !== void 0 ? _pkg$module : '')];
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 16:
          ...
          pathToPackage = getRelativePathFromJson(pkg); // A list of files to ignore in the size calculations.
          ignore = [
        ...
        case 29:
          _context2.next = 31;
          return writeJSON(PATH.sizeLimit, sizes);
        case 31:
...
var pnpmFolder = baseDir('node_modules', '.pnpm');
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 8:
          ...
          if (name.startsWith('@')) {
            split = name.split('/');
            folderName = "".concat(assertGet(split, 0), "+").concat(assertGet(split, 1));
          }
          directory = searchFolders.find(name => name.startsWith("".concat(folderName, "@")));
          !directory ? process.env.NODE_ENV !== "production" ? invariant(false, {
            message: "No directory found for ".concat(name)
          }) : invariant(false) : void 0;
          return _context3.abrupt("return", path.join(base, directory, 'node_modules', name, subFolder.endsWith('.d.ts') ? subFolder : path.join(subFolder, 'index.d.ts')));
        case 15:
        case "end":
  ...
  _resolveTsConfigMeta = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(pkg, dependencies, types) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 4:
          _context4.next = 6;
          return readdir(pkg.location);
        case 6:
          foldersInDirectory = _context4.sent;
          mergedMeta = deepMerge(DEFAULT_TSCONFIG_META, meta !== null && meta !== void 0 ? meta : {});
          ...
          filepath = path.join(pkg.location, 'src', tsconfigFileName); // Collect all the references need for the current package.
          ...
          configFiles.push({
            ...
            json: _objectSpread(_objectSpread(_objectSpread({}, createAutoGeneratedFlag('src')), {}, {
              ...
              references: pkg.name === '@remirror/support' ? [{
                path: path.relative(path.dirname(filepath), (_dependencies$remirro = dependencies['remirror']) !== null && _dependencies$remirro !== void 0 ? _dependencies$remirro : '')
              }] : references
            })
          });
        case 25:
          if (main) {
            _filepath = path.join(pkg.location, tsconfigFileName);
            ...
            compilerOptions = deepMerge(src !== false ? (_src$compilerOptions2 = src === null || src === void 0 ? void 0 : src.compilerOptions) !== null && _src$compilerOptions2 !== void 0 ? _src$compilerOptions2 : {} : {}, original);
            configFiles.push({
              shouldReference: false,
              filepath: _filepath,
              json: _objectSpread(_objectSpread({}, createAutoGeneratedFlag('src')), {}, {
                extends: makeRelative(path.relative(path.dirname(_filepath), PATH.baseTsconfig)),
                compilerOptions
              }, other)
            });
          }
        ...
        case 31:
          _filepath2 = path.join(pkg.location, folder, tsconfigFileName);
        ...
        case 44:
          compilerOptionsPaths[entry] = [path.join(path.relative(path.dirname(_filepath2), path.join(_dependencyPath, 'src', 'index.ts')))];
          return _context4.abrupt("continue", 51);
        case 46:
        ...
        case 49:
          ...
          compilerOptionsPaths[name] = [path.join(path.relative(path.dirname(_filepath2), pathToDefinitionFile))];
        case 51:
          _context4.next = 38;
          break;
        case 53:
        ...
        case 61:
          _compilerOptions = deepMerge(src !== false ? (_src$compilerOptions3 = src === null || src === void 0 ? void 0 : src.compilerOptions) !== null && _src$compilerOptions3 !== void 0 ? _src$compilerOptions3 : {} : {}, _original, {
          ...
          if (folder.startsWith('__')) {
            testingPath = path.relative(path.dirname(_filepath2), path.join((_dependencies$testing = dependencies['testing']) !== null && _dependencies$testing !== void 0 ? _dependencies$testing : '', 'src'));
            remirrorPath = path.relative(path.dirname(_filepath2), path.join((_dependencies$remirro2 = dependencies['remirror']) !== null && _dependencies$remirro2 !== void 0 ? _dependencies$remirro2 : '', 'src'));
            extraReferences.push({
              path: testingPath
            }, {
              path: remirrorPath
          ...
          configFiles.push({
            ...
            json: _objectSpread(_objectSpread(_objectSpread({}, createAutoGeneratedFlag(folder)), {}, {
              extends: path.relative(path.dirname(_filepath2), PATH.baseTsconfig),
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 17:
          ...
          _context6.next = 21;
          return writeJSON(PATH.rootTsconfig, {
            include: [],
            files: [],
            references
          }, {
        ...
        case 21:
          ...
          _context6.next = 24;
          return writeJSON(PATH.packagesTsconfig, packagesTsconfig, {
            detectIndent: true
          });
        case 24:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 19:
          ...
          _context7.next = 22;
          return formatFiles(filesToPrettify, {
            silent: true,
            formatter: 'prettier'
          });
        case 22:
